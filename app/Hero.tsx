...
const Hero = () => {
  return (
    ...
    sm:top-20 sm:left-0"  fill='purple' />
      ...
      <div className="h-screen w-full dark:bg-black bg-white  dark:bg-grid-white/[0.05] bg-grid-black/[0.05]  flex items-center justify-center absolute top-0 left-0">
